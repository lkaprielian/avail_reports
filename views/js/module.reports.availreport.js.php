...
<script type="text/javascript">
    jQuery(function($) {
        function availreportPage() {
            ...
            this.timeout = null;
            this.deferred = null;
            this.timeselector_data = null; // Add a property to store timeselector data
            ...
            // Save timeselector data when filter button is clicked
            $('#your_filter_button_id').on('click', () => {
                if (window.availreport_page && window.availreport_page.timeselector_data) {
                    window.availreport_page.timeselector_data = { ...window.availreport_page.timeselector_data };
                }
            });
        }
        ...
        // Subscribe to timeselector.rangeupdate event
        jQuery.subscribe('timeselector.rangeupdate', function(e, data) {
            if (window.availreport_page) {
                ...
                // Save timeselector data
                window.availreport_page.timeselector_data = data;
            }
        });
    });
</script>
